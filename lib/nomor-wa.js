 ...
 * dipakai DI DALAM satu nomor (0812-3456-7890). Garis miring, koma,
 * titik koma, dan kata "dan" TIDAK -- itulah yang dipakai memisahkan
 * nomor ayah dari nomor ibu di satu sel yang sama, sehingga keduanya
 * terbaca sebagai dua temuan, bukan satu nomor 22 digit yang lalu
 * ditolak.
 *
 * GANTI BARIS JUGA MEMISAHKAN, dan itu sebabnya kelas karakter di bawah
 * menyebut spasi dan tab satu per satu alih-alih memakai \s. Alt+Enter
 * di dalam satu sel Google Sheets adalah cara yang sangat wajar menulis
 * dua nomor, dan \s akan menelan ganti barisnya -- membuat kedua nomor
 * melebur menjadi satu deret 26 digit yang lalu ditolak seluruhnya.
 * Orang tua yang nomornya sah pun menjadi tidak dikenali.
 */
const RUNTUN_ANGKA = /\+?\d[\d \t.()-]{6,}\d/g;
